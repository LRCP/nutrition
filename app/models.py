...
#The relationship between the food and the weight is many to one 
#because many foods can have the same unit of weight.
...
#user has a relationship with food_logs
#one user can have multiple food_logs
